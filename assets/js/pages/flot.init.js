!function (n) {
    ...
    t.prototype.createPlotGraph = function (t, a, o, e, r, l, i, s) {
        n.plot(n(t), [{data: a, label: r[0], color: l[0]}, {data: o, label: r[1], color: l[1]}, {
            ...
            yaxis: {min: 0, max: 300, tickColor: "rgba(166, 176, 207, 0.1)", font: {color: "#8791af"}},
            xaxis: {tickColor: "rgba(166, 176, 207, 0.1)", font: {color: "#8791af"}},
            tooltip: !0,
        ...
        return n.plot(t, [a], {
            ...
            yaxis: {min: 0, max: 100, tickColor: "rgba(166, 176, 207, 0.1)", font: {color: "#8791af"}},
            xaxis: {show: !1}
        })
        ...
        this.createPlotGraph("#website-stats", [[0, 50], [1, 130], [2, 80], [3, 70], [4, 180], [5, 105], [6, 250]], [[0, 80], [1, 100], [2, 60], [3, 120], [4, 140], [5, 100], [6, 105]], [[0, 20], [1, 80], [2, 70], [3, 140], [4, 250], [5, 80], [6, 200]], ["Desktops", "Laptops", "Tablets"], ["#f0f1f4", "#5664d2", "#1cbb8c"], "rgba(166, 176, 207, 0.1)", "transparent");
        this.createPieGraph("#pie-chart #pie-chart-container", ["Desktops", "Laptops", "Tablets"], [20, 30, 15], ["#5664d2", "#1cbb8c", "#ebeff2"]);
        var a = this.createRealTimeGraph("#flotRealTime", this.randomData(), ["#1cbb8c"]);
        a.draw();
        var o = this;
        !function t() {
            a.setData([o.randomData()]), a.draw(), setTimeout(t, (n("html").hasClass("mobile-device"), 1e3))
        }();
        this.createDonutGraph("#donut-chart #donut-chart-container", ["Desktops", "Laptops", "Tablets"], [29, 20, 18], ["#f0f1f4", "#5664d2", "#1cbb8c"])
